...
FEATURE_NAMES = [
    ...
    "vibe_x_max", "vibe_y_max", "vibe_z_max", "vibe_z_std", "vibe_clip_total", "vibe_z_tanomaly",
    "mag_field_mean", "mag_field_max", "mag_field_range", "mag_field_std",
    "mag_x_range", "mag_y_range", "mag_tanomaly",
    ...
    "gps_hdop_mean", "gps_hdop_max", "gps_nsats_mean", "gps_nsats_min", "gps_fix_pct", "gps_hdop_tanomaly",
    "motor_spread_mean", "motor_spread_max", "motor_spread_std", "motor_spread_tanomaly",
    ...
    "evt_rc_lost_count", "evt_radio_failsafe_count",
