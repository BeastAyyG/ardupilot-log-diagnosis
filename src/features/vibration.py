...
class VibrationExtractor(BaseExtractor):
    ...
    FEATURE_NAMES = [
        ...
        "vibe_x_max", "vibe_y_max", "vibe_z_max",
        "vibe_z_std", "vibe_clip_total"
    ]
    ...
    def extract(self) -> dict:
        ...
        x_stats = self._safe_stats(x_vals)
        y_stats = self._safe_stats(y_vals)
        z_stats = self._safe_stats(z_vals)
