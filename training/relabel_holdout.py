...
def relabel():
    ...
    out_path = "data/holdouts/production_holdout_clean/ground_truth.json"
    ...
    for i, log_entry in enumerate(data.get("logs", [])):
        ...
        if is_symptom or len(original_labels) == 0:
            ...
            if strongest_cause:
                print(f"Relabeling Holdout {log_entry['filename']}")
    ...
    print(f"\nSuccessfully relabeled {relabeled_count} holdout logs.")
