...
> **Measured status:** on real-log benchmark v1, CITA shows **no measurable benefit**. It changed 20 of 41 top predictions, and 8 of 41 were correct with or without it ([evidence](docs/EVIDENCE_LEDGER.md)). The labels are provisional and have no onset annotations. A proper test needs annotated onset times, which is planned in [`docs/PUBLICATION_PLAN.md`](docs/PUBLICATION_PLAN.md). Treat the description below as the design intent.
