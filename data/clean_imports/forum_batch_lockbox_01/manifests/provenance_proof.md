...
- Source folder: `/home/ayyg/ardupilot-log-diagnosis/data/raw_downloads/forum_batch_lockbox_01`
- Generated at (UTC): `2026-02-22T20:39:58.383394+00:00`
- Total `.bin` files scanned: **8**
- Parse-valid `.bin` files (pre-dedupe): **8**
- Unique parse-valid files (SHA256 dedupe): **8**
- Rejected non-log `.bin` files: **0**
- Provisional labeled files (not trainable): **0**
- Unlabeled files (manual review): **0**
- Benchmark-trainable files: **8**
...
| `log_0008_pid_tuning_issue.bin` | PID_TUNING_ISSUE | pid_tuning_issue | https://discuss.ardupilot.org/t/how-to-make-yaw-roll-and-pitch-smoother/64483 | https://www.dropbox.com/s/vbfj9poy4plergf/15-Dec-2020-Crash.BIN?dl=1 | `4dbb9b5fad2e1da945dd1969dc1632091869e3980391666a75106b47015b5e92` |
...
## Generated Artifacts
- `data/clean_imports/forum_batch_lockbox_01/manifests/source_inventory.csv`
- `data/clean_imports/forum_batch_lockbox_01/manifests/clean_import_manifest.csv`
- `data/clean_imports/forum_batch_lockbox_01/manifests/rejected_manifest.csv`
- `data/clean_imports/forum_batch_lockbox_01/manifests/ground_truth_candidate.json`
- `data/clean_imports/forum_batch_lockbox_01/benchmark_ready/ground_truth.json`
